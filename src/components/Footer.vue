  ...
  <footer class="text-center lg:text-left bg-gray-100 text-gray-600">
    ...
    >
      ...
      <div class="flex justify-center">
        ...
        <a href="https://www.instagram.com/entitaz.id/" target="_blank">
          <Icon class="text-2xl" icon="akar-icons:instagram-fill" />
        </a>
      </div>
    </div>
    <div class="mx-6 py-10 text-center md:text-left">
      <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <div class="">
          ...
          <p>
            Connecting Your Dream To Reality. We assist youth to develop their
            potential and take them to the next level.
          </p>
        </div>
        <!-- konten footer -->
        <!-- <div class="">
